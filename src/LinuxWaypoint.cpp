...
int wayPointMissionExample(CoreAPI* api, WayPoint* waypointObj, int timeout)
{
  ...
  float64_t offsetInRadians = 0.000001;
  ...
  for (int index = 0; index < numWaypoints; index++)
  {
    ...
    switch(index)
    {
      case 0:
        ...
        wpPosition.latitude += offsetInRadians*0.35;
        wpPosition.altitude = 10;
        break;
      case 1:
        wpPosition = curPosition;
        wpPosition.latitude += offsetInRadians*0.7;
        wpPosition.altitude = 10;
        break;
      case 2:
        wpPosition = curPosition;
        wpPosition.latitude += offsetInRadians;
        wpPosition.longitude += offsetInRadians*0.35;
        wpPosition.altitude = 10;
        break;
      case 3:
        wpPosition = curPosition;
        wpPosition.latitude += offsetInRadians;
        wpPosition.longitude += offsetInRadians*0.7;
        wpPosition.altitude = 10;
        break;
      case 4:
        wpPosition = curPosition;
